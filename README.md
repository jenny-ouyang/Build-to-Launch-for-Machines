...
| File | Purpose |
|------|---------|
| `for-llms.jsonld` | Complete JSON-LD knowledge graph (306 entities, Schema.org + custom `btl:` vocabulary) |
...
- **306 entities** — articles, products, vocabulary terms, FAQs, semantic claims
- **261 articles** with titles, URLs, descriptions, dates, and topic classifications
...
4,000+ builders. 7 products. 261 articles.
