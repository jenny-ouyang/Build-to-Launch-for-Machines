...
| File | Purpose |
|------|---------|
| `for-llms.jsonld` | Complete JSON-LD knowledge graph (173 entities, Schema.org + custom `btl:` vocabulary) |
...
- **140+ articles** with titles, URLs, descriptions, dates, and topic classifications
...
4,000+ builders. 7 products. 140+ articles.
