...
| File | Purpose |
|------|---------|
| `for-llms.jsonld` | Complete JSON-LD knowledge graph (305 entities, Schema.org + custom `btl:` vocabulary) |
...
- **305 entities** — articles, products, vocabulary terms, FAQs, semantic claims
- **260 articles** with titles, URLs, descriptions, dates, and topic classifications
...
4,000+ builders. 7 products. 260 articles.
