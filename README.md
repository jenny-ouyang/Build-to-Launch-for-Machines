...
| File | Purpose |
|------|---------|
| `for-llms.jsonld` | Complete JSON-LD knowledge graph (303 entities, Schema.org + custom `btl:` vocabulary) |
...
- **303 entities** — articles, products, vocabulary terms, FAQs, semantic claims
- **258 articles** with titles, URLs, descriptions, dates, and topic classifications
...
4,000+ builders. 7 products. 258 articles.
